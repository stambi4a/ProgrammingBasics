namespace Problem_04.Nine_Digit_Magic_Numbers
{
    using System;
    ...
    {
        private const int MinSum = 7;
        private const int MaxSum = 63;
        private const int MinDifference = 0;
        private const int MaxDifference = 444;
        private const int MinDigit = 1;
        private const int MaxDigit = 7;
